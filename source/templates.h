...
double total_fb (WindPtr one, double t, double f1, double f2, double mode);
...
int populate_ion_rate_matrix (PlasmaPtr xplasma, double rate_matrix[nions][nions], double pi_rates[nions], double inner_rates[n_inner_tot],
                              double rr_rates[nions], double b_temp[nions], double xne, int xelem[nions]);
