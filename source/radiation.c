     ...
     double w_ave;
{
  ...
  {
	  Log ("NSH cell %i nphot %i w_ave %e ds %e freq %e origin %i nscat %i gen_cell %i vol %e NMPI %i j=%e\n",xplasma->nplasma,p->np,w_ave,ds,p->freq,p->origin,p->nscat,photon_source[p->np],xplasma->vol,rank_global,xplasma->j);
  }
